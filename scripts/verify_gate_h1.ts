...
} from '../src/core/symbolic_diff';

const corpus = [
  { id: 1, name: 'Power rule positive integer', expr: 'x^5', var: 'x' },
  { id: 2, name: 'Power rule negative exponent', expr: 'x^(-3)', var: 'x', domain: [0.5, 4.0] as [number, number] },
  { id: 3, name: 'Power rule positive rational exponent', expr: 'x^(1/2)', var: 'x', domain: [0.5, 4.0] as [number, number] },
  { id: 4, name: 'Power rule negative rational exponent', expr: 'x^(-2/3)', var: 'x', domain: [0.5, 4.0] as [number, number] },
  ...
  { id: 11, name: 'Product rule linear and logarithmic', expr: 'x * ln(x)', var: 'x', domain: [0.5, 5.0] as [number, number] },
  { id: 12, name: 'Quotient rule rational fraction', expr: 'x / (x + 1)', var: 'x', domain: [0.5, 5.0] as [number, number] },
  { id: 13, name: 'Quotient rule sinc function', expr: 'sin(x) / x', var: 'x', domain: [0.5, 5.0] as [number, number] },
  { id: 14, name: 'Quotient rule exponential over power', expr: 'exp(x) / (x^2)', var: 'x', domain: [0.5, 5.0] as [number, number] },
  ...
  { id: 18, name: 'Chain rule tan of linear', expr: 'tan(2 * x)', var: 'x', domain: [-0.6, 0.6] as [number, number] },
  ...
  { id: 23, name: 'Trig tan', expr: 'tan(x)', var: 'x', domain: [-1.2, 1.2] as [number, number] },
  { id: 24, name: 'Inverse trig asin', expr: 'asin(x)', var: 'x', domain: [-0.8, 0.8] as [number, number] },
  { id: 25, name: 'Inverse trig acos', expr: 'acos(x)', var: 'x', domain: [-0.8, 0.8] as [number, number] },
  ...
  { id: 32, name: 'Natural logarithm', expr: 'ln(x)', var: 'x', domain: [0.5, 5.0] as [number, number] },
  { id: 33, name: 'General base logarithm', expr: 'log(x, 10)', var: 'x', domain: [0.5, 5.0] as [number, number] },
  { id: 34, name: 'Logarithmic differentiation', expr: 'x^x', var: 'x', domain: [0.5, 4.0] as [number, number] },
  { id: 35, name: 'Nested chain rule', expr: 'sin(exp(x^2))', var: 'x', domain: [-1.2, 1.2] as [number, number] },
];
